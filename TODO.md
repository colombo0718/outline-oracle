...
- [ ] LINE push 觸發
- [ ] snooze 機制（「再等我一小時」）
- [ ] 自然提醒語氣（伶伶式催促 vs 凌凌式預警）

## Phase 4：檔案管理（從 cwsoft 移植）

- [ ] LINE 檔案接收 → R2 上傳
- [ ] 檔案 metadata 寫 D1
- [ ] 翎翎讀檔 → 一句話 summary 寫回 files.summary
- [ ] 自然語言檢索（「上週那份合約」→ 撈出檔案）
...
1. [ ] `project-ll-lingling-three-names-three-personas.md` — 伶伶/翎翎/凌凌規格、對位依依三身一名
2. [ ] 更新 `project-ll-lore-locations.md` — 加入藏經閣、跟精算閣對位
...
6. [ ] `project-ll-cwsoft-synergy.md` — 阿全 / 凌凌 / 生產線 R&D 關係
